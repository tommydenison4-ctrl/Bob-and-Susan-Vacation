...
export type Expense={id:string;dayId:string;merchant:string;amount:number;currency:string;cadAmount?:number;category:ExpenseCategory;paymentMethod:PaymentMethod;notes?:string;receiptDataUrl?:string;tax?:number;tip?:number;purchasedAt?:string;ocrText?:string;createdAt:string};
